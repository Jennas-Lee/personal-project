...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="sms.html" class="nav-link">단체문자 <i class="fas fa-sms"></i></a> <!-- Should change file name to php -->
                    </li>
                    <li class="nav-item">
    ...
    <main role="main">
        ...
        <div class="container">
            <table id="memberTable" class="table table-striped text-center tablesorter">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">반</th>
                ...
                <tbody>
                    <?php
                        $sql="SELECT * FROM STUDENT_TB WHERE NAME='{$_GET['name']}'";
                        $result=mysqli_query($conn, $sql);

                        $i=1;
                        while($row=mysqli_fetch_array($result)) {
                            $stunum = "010-".substr($row['stunum'], 3, 4)."-".substr($row['stunum'], 7, 4);
                            $parnum = "010-".substr($row['parnum'], 3, 4)."-".substr($row['parnum'], 7, 4);
