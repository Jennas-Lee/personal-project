    ...
    <main role="main">
        ...
        <div class="container">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link" id="grade0" href="tuition.php?page=1&grade=0">전체</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="tuition.php?grade=1&g=1">초1</a>
                        <a class="dropdown-item" href="tuition.php?grade=1&g=2">초2</a>
                        <a class="dropdown-item" href="tuition.php?grade=1&g=3">초3</a>
                        <a class="dropdown-item" href="tuition.php?grade=1&g=4">초4</a>
                        <a class="dropdown-item" href="tuition.php?grade=1&g=5">초5</a>
                        <a class="dropdown-item" href="tuition.php?grade=1&g=6">초6</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="tuition.php?grade=2&g=1">중1</a>
                        <a class="dropdown-item" href="tuition.php?grade=2&g=2">중2</a>
                        <a class="dropdown-item" href="tuition.php?grade=2&g=3">중3</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="tuition.php?grade=3&g=1">고1</a>
                        <a class="dropdown-item" href="tuition.php?grade=3&g=2">고2</a>
                        <a class="dropdown-item" href="tuition.php?grade=3&g=3">고3</a>
                    </div>
                </li>
            </ul>
            <table id="memberTable" class="table table-striped text-center tablesorter mt-4">
                <thead>
                    <tr>
                        ...
                        <th scope="col">이름</th>
                        <th scope="col">납부일</th>
                        <th scope="col"><?php echo date("n"); ?>월 납부여부</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        ...
                        if($grade == 0) {
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                $sql = "SELECT * FROM TUITION_TB WHERE stunum = '".$row['stunum']."' AND date LIKE '".$date."%'";
                                $dateresult = mysqli_query($conn, $sql);
                                if(mysqli_num_rows($dateresult) == 0) $tui = '<span class="text-danger">아니요 <a href="checktuition.php?num='.$row['stunum'].'">확인</a></span>';
                                else $tui = '<span class="text-primary">예</span>';
                                echo '<tr>
                                    <th scope="row">'.$i.'</th>
                                    <td>'.$row['class'].'</td>
                    ...
                    <?php
                        if($grade == 0) {
                            if($page == 1) {
                                ...
                                ?>
                                    <li class="page-item">
                                        <a class="page-link" href="tuition.php?page=<?php echo $page - 1; echo "&grade=".$grade ?>" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                <?php
                            ...
                            for($i = $block_start; $i <= $block_end; $i++) {
                                if($page == $i) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="tuition.php?page='.$i.'grade='.$grade.'">'.$i.'</a></li>';
                                }
                            }
                        ...
                        <?php
                            if($page == ceil($row_num/10)) {
                                ...
                                ?>
                                    <li class="page-item">
                                        <a class="page-link" href="tuition.php?page=<?php echo $page + 1; echo "&grade=".$grade ?>" aria-label="Next">
                                            <span aria-hidden="true">&raquo;</span>
                                        </a>
                                    </li>
                                <?php
